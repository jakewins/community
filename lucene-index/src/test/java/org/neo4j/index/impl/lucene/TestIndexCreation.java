...
public class TestIndexCreation
{
    ...
    {
        XaDataSource ds = db.getXaDataSourceManager().getXaDataSource( LuceneDataSource.DATA_SOURCE_NAME );
        ...
        {
            if ( entry instanceof LogEntry.Command && ((LogEntry.Command) entry).getXaCommand() instanceof IndexCommand.CreateCommand )
            {
