...
public abstract class GraphDatabaseSettings
{
    ...
    @Default("20M")
    public static final Setting<Long> nodestore_mapped_memory_size = new NumberOfBytesSetting("neostore.nodestore.db.mapped_memory");

    @Description( "The size to allocate for memory mapping the property value store." )
    @Default("90M")
    public static final Setting<Long> nodestore_propertystore_mapped_memory_size = new NumberOfBytesSetting("neostore.propertystore.db.mapped_memory");

    @Description( "The size to allocate for memory mapping the store for property key indexes." )
    @Default("1M")
    public static final Setting<Long> nodestore_propertystore_index_mapped_memory_size = new NumberOfBytesSetting("neostore.propertystore.db.index.mapped_memory");

    @Description( "The size to allocate for memory mapping the store for property key strings." )
    @Default("1M")
    public static final Setting<Long> nodestore_propertystore_index_keys_mapped_memory_size = new NumberOfBytesSetting("neostore.propertystore.db.index.keys.mapped_memory");

    @Description( "The size to allocate for memory mapping the string property store." )
    @Default("130M")
    public static final Setting<Long> strings_mapped_memory_size = new NumberOfBytesSetting("neostore.propertystore.db.strings.mapped_memory");

    @Description( "The size to allocate for memory mapping the array property store." )
    @Default("130M")
    public static final Setting<Long> arrays_mapped_memory_size = new NumberOfBytesSetting("neostore.propertystore.db.arrays.mapped_memory");

    @Description( "The size to allocate for memory mapping the relationship store." )
    @Default("100M")
    public static final Setting<Long> relationshipstore_mapped_memory_size = new NumberOfBytesSetting("neostore.relationshipstore.db.mapped_memory");
    ...
    @Default( "100ms" )
    public static final Setting<Long> gc_monitor_interval = new TimeSpanSetting( "gc_monitor_wait_time" );

    @Description( "The amount of time in ms the monitor thread has to be blocked before logging a message it was blocked." )
    @Default( "200ms" )
    public static final Setting<Long> gc_monitor_block_threshold = new TimeSpanSetting( "gc_monitor_threshold" );
    ...
    public static final Setting<Long> gcr_node_cache_size = new GCRMemoryUsageSetting( "node_cache_size");

    @Description( "The amount of memory to use for the relationship cache (when using the 'gcr' cache)." )
    public static final Setting<Long> gcr_relationship_cache_size = new GCRMemoryUsageSetting( "relationship_cache_size");
    ...
    @Default( "60s" )
    public static final Setting<Long> gcr_cache_log_interval = new TimeSpanSetting( "gcr_cache_min_log_interval");
     ...
     */
    @Default( TRUE)
    public static final Setting<Boolean> udc_enabled = new GraphDatabaseSetting.BooleanSetting("neo4j.ext.udc.enabled");
     ...
     */
    @Default( ""+10 * 1000 * 60 )
    public static final Setting<Integer> first_delay = new GraphDatabaseSetting.IntegerSetting("neo4j.ext.udc.first_delay", "Must be nr of milliseconds to delay", 1, null);
    ...
    public static final Setting<Integer> interval = new GraphDatabaseSetting.IntegerSetting("neo4j.ext.udc.interval", "Must be nr of milliseconds of the interval for checking", 1, null);
    ...
    public static final Setting<String> udc_host = new GraphDatabaseSetting.StringSetting(  "neo4j.ext.udc.host", ANY, "Must be a valid hostname");

    /**
     * Configuration key for overriding the source parameter in UDC
     */
    public static final Setting<String> udc_source = new GraphDatabaseSetting.StringSetting("neo4j.ext.udc.source", ANY, "Must be a valid source");

    /**
     * Unique registration id
     */
    @Default( "unreg" )
    public static final Setting<String> udc_registration_key = new GraphDatabaseSetting.StringSetting( "neo4j.ext.udc.reg", ANY, "Must be a valid registration id" );
