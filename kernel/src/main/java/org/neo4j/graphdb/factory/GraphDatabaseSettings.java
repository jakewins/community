...
public abstract class GraphDatabaseSettings
{
    ...
    @Default( "100ms" )
    public static TimeSpanSetting gc_monitor_wait_time = new TimeSpanSetting( "gc_monitor_wait_time" );

    @Description( "The amount of time in ms the monitor thread has to be blocked before logging a message it was blocked." )
    @Default( "200ms" )
    public static TimeSpanSetting gc_monitor_threshold = new TimeSpanSetting( "gc_monitor_threshold" );
